...
In this guide we will be demonstrating how to set up a highly-available Teleport Access deployment. 
...
Due to my personal setup all the shell commands and scripts mentioned in this guide (and provided in the GitHub repository at the end) will be using `Bash`.
...
Note the following
- since we are deploying a highly-available configuration we have set the node count to 3
...
To set up all these resources add the following code to your `main.tf`
```terraform
# Teleport
